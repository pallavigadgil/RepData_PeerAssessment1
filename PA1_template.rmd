...
stepMedian
```
Total number of steps taken mean : **`r stepMean`** and median : **`r stepMedian`**
...
Total number of steps taken  with new data set mean : **`r stepMeanNew`** and median : **`r stepMedianNew`**

Impact of missing values on mean is **`r stepMeanNew-stepMean`** and on median is **`r stepMedianNew-stepMedian`**
